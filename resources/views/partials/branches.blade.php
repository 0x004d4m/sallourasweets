                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <p>
                                <a href="tel:{{ $branch->phone }}" target="_blank" class="btn btn-outline-primary"><i class="fa fa-phone"></i></a>
                                <a href="{{ $branch->location }}" target="_blank" class="btn btn-outline-primary"><i class="fa fa-map-marker"></i></a>
                            </p>
                        </div>
                    </div>
                </div>
