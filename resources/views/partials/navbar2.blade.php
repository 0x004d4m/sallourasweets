        ...
        <div class="offcanvas-body">
            <div>
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    <li class="nav-item"><a type="button" class="nav-link" href="{{ url('/#carouselExampleSlidesOnly') }}">{{ __('content.Home') }}</a></li>
                    <li class="nav-item"><a type="button" class="nav-link" href="{{ url('/#menu') }}">{{ __('content.Menu') }}</a></li>
                    <li class="nav-item"><a type="button" class="nav-link" href="{{ url('/#branches') }}">{{ __('content.Branches') }}</a></li>
                    <li class="nav-item"><a type="button" class="nav-link" href="{{ url('/#features') }}">{{ __('content.Features') }}</a></li>
                    <li class="nav-item"><a type="button" class="nav-link" href="{{ url('/#about') }}">{{ __('content.About') }}</a></li>
                </ul>
            </div>
